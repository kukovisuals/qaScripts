...
/*   
    grab the name from the array /products/nude-bralette
    const pdpName = nude-bikini-panties
*/
const bottom = ['bikini','panties','brief','high-cut','high-waisted','highwaisted','shorts']
